...
export function InventoryPanel() {
  ...
  const used = player.property.effectiveStorageUsed; const percent = player.property.storageCapacity>0?Math.min(100,Math.round((used/player.property.storageCapacity)*100)):0;
